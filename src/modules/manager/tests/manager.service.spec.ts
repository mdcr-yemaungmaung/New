...
describe('ManagerService', () => {
  ...
  describe('startReview', () => {
    ...
    it('should handle notification creation failure gracefully in startReview', async () => {
      const mockRequest = buildMockPaymentRequest();
      const updatedMockRequest = buildMockPaymentRequest({
        statusId: PaymentStatus.MANAGER_REVIEWING,
      });
  ...
  describe('verifyRequest', () => {
    ...
    it('should handle notification creation failure gracefully in verifyRequest', async () => {
      const mockRequest = buildMockPaymentRequest({
        statusId: PaymentStatus.MANAGER_REVIEWING,
        currentAssignedToUserId: mockManagerId,
      });
  ...
  describe('rejectRequest', () => {
    ...
    it('should handle second WebSocket notification to applicant failure gracefully in rejection', async () => {
      const mockRequest = buildMockPaymentRequest({
        statusId: PaymentStatus.MANAGER_REVIEWING,
        currentAssignedToUserId: mockManagerId,
      });
      ...
      websocketGateway.sendPersonalNotification.mockImplementation(() => {
        ...
        if (callCount.count === 2) {
          throw new Error('Applicant WebSocket notification failed');
        }
      });
    ...
    it('should handle notification creation failure gracefully in rejection', async () => {
      const mockRequest = buildMockPaymentRequest({
        statusId: PaymentStatus.MANAGER_REVIEWING,
        currentAssignedToUserId: mockManagerId,
      });
