...
export class AdminController {
   ...
   * @param search Combined search filter for employee number or name.
   * @param employeeNumber Search filter for employee number (ignored when search is provided).
   * @param employeeName Search filter for employee full name (ignored when search is provided).
