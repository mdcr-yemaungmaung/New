          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">
                {t('applicant.detail.created_on')} {formatDate(data.created_at)}
              </p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 space-y-4">
              ...
              <div>
                ...
                {isEditing && editData ? (
                  ...
                  <p className="text-sm text-slate-900 font-medium">{formatDate(data.application_date)}</p>
                )}
              </div>
              ...
              <div>
                ...
                {isEditing && editData ? (
                  ...
                  <p className="text-sm text-slate-900 font-medium">{formatDate(data.desired_payment_date)}</p>
                )}
              </div>
