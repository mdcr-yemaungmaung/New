...
import { KpiCard, DashboardKpiGrid, SearchFilterBar, StatusBadge } from '../../components/shared';
...
export function ManagerDashboard() {
  ...
  const columns: Column<PaymentRequestWithApplicant>[] = useMemo(() => [
    ...
    {
      key: 'branch',
      header: t('dashboard.manager.branch'),
      render: (_, row) => (
    ...
    },
    {
      ...
      header: t('dashboard.manager.desired_payment_date'),
      render: (_, row) => (
    ...
    },
    {
      ...
      render: (_, row) => (
        <StatusBadge statusId={row.statusId} size="sm" />
      ),
      width: '12%',
    },
    {
      key: 'action',
      header: t('dashboard.manager.action'),
      render: (_, row) => (
        <button
          type="button"
